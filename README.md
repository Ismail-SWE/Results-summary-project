...
While working on this project, I improved my understanding of CSS Flexbox
for centering and aligning elements. I also practiced using CSS custom
properties to keep colors and styles consistent throughout the project.
...
- Learning how to dynamically populate content using JavaScript and JSON
